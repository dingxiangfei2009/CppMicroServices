...
TEST_F(BundleHooksTest, TestEventHook)
{
  ...
  std::cout<< bundleListener.events.at(0).GetType();
  std::cout << bundleListener.events.at(1).GetType();
  std::cout << bundleListener.events.at(2).GetType();
  std::cout << bundleListener.events.at(3).GetType();
